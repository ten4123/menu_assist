...
const OnboardingIllustration = () => {
    return (<svg width="352" height="192" viewBox="0 0 352 192" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block' }}>
      <g clipPath="url(#clip0_0_20242)">
        <rect width="352" height="192" fill="#333333" style={{ fill: '#333333', fillOpacity: 1 }}/>
        <rect x="25" y="33" width="206" height="126" stroke="white" style={{ stroke: 'white', strokeOpacity: 1 }} strokeWidth="2"/>
...
export const Root = {
    argTypes: {
        defaultOpen: {
            type: 'boolean',
            description: 'The state of the dialog when it is initially rendered. Use when you do not need to control its state.',
        },
        open: {
            type: 'boolean',
