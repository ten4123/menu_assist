...
export default meta;
const SimpleSelectElement = (<Select.Root value="drop-shadow">
    <Select.Trigger />
    <Select.Content>
...
const SeparatorsElement = (<Select.Root value="one">
    <Select.Trigger />
    <Select.Content>
...
const GroupsAndLabelsElement = (<Select.Root value="passthrough">
    <Select.Trigger />
    <Select.Content>
      <Select.Group>
