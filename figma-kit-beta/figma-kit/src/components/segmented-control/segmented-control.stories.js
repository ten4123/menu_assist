...
export const Basic = {
    render() {
        return (<SegmentedControl.Root defaultValue="left">
...
export const FullWidth = {
    ...
    render() {
        return (<SegmentedControl.Root fullWidth defaultValue="left">
        <SegmentedControl.Item value="left" aria-label="Align left">
          <IconAlignLeft />
        </SegmentedControl.Item>
        <SegmentedControl.Item value="center" aria-label="Align center">
...
export const Disabled = {
    render() {
        return (<SegmentedControl.Root defaultValue="left" disabled>
        <SegmentedControl.Item value="left" aria-label="Align left">
          <IconAlignLeft />
        </SegmentedControl.Item>
        <SegmentedControl.Item value="center" aria-label="Align center">
...
export const Text = {
    render() {
        return (<SegmentedControl.Root defaultValue="minimalist">
...
const IconAlignRight = () => {
    return (<svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" viewBox="0 0 14 10" fill="none">
      <path fill="var(--color-icon)" fillRule="evenodd" stroke="none" d="M0 0h14v1H0V0zm6 4h8v1H6V4zm8 4H4v1h10V8z"></path>
    </svg>);
};
const IconAlignCenter = () => {
    return (<svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" viewBox="0 0 14 10" fill="none">
      <path fill="var(--color-icon)" fillRule="evenodd" stroke="none" d="M0 0h14v1H0V0zm3 4h8v1H3V4zm9 4H2v1h10V8z"></path>
    </svg>);
};
const IconAlignJustify = () => {
    return (<svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" viewBox="0 0 14 10" fill="none">
      <path fill="var(--color-icon)" fillRule="evenodd" stroke="none" d="M0 0h14v1H0V0zm0 4h14v1H0V4zm14 4H0v1h14V8z"></path>
    </svg>);
};
